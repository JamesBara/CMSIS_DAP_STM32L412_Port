...
__STATIC_INLINE void PORT_SWD_SETUP (void) {
    /*Clear PA0(nReset), PA1(SWCLK) and PA2(SWDIO).*/
    CLEAR(GPIOA->MODER, (GPIO_MODER_MODE0 | GPIO_MODER_MODE1 | GPIO_MODER_MODE2));
    CLEAR(GPIOA->OTYPER, (GPIO_OTYPER_OT0 | GPIO_OTYPER_OT1 | GPIO_OTYPER_OT2));
    CLEAR(GPIOA->OSPEEDR, (GPIO_OSPEEDR_OSPEED0 | GPIO_OSPEEDR_OSPEED1 | GPIO_OSPEEDR_OSPEED2));
    CLEAR(GPIOA->PUPDR, (GPIO_PUPDR_PUPD0 | GPIO_PUPDR_PUPD1 | GPIO_PUPDR_PUPD2));
    CLEAR(GPIOA->AFRL, (GPIO_AFRL_AFSEL0 | GPIO_AFRL_AFSEL1 | GPIO_AFRL_AFSEL2));
    /*Set PA0(nReset), PA1(SWCLK) and PA2(SWDIO).*/
    SET(GPIOA->MODER, (GPIO_MODER_MODE0_OUTPUT | GPIO_MODER_MODE1_OUTPUT | GPIO_MODER_MODE2_OUTPUT));
...
__STATIC_INLINE void PORT_OFF (void) {
    ...
    CLEAR(GPIOA->OSPEEDR, (GPIO_OSPEEDR_OSPEED0 | GPIO_OSPEEDR_OSPEED1 | GPIO_OSPEEDR_OSPEED2));
    CLEAR(GPIOA->PUPDR, (GPIO_PUPDR_PUPD0 | GPIO_PUPDR_PUPD1 | GPIO_PUPDR_PUPD2));
    SET(GPIOA->MODER, (GPIO_MODER_MODE0_ANALOG | GPIO_MODER_MODE1_ANALOG | GPIO_MODER_MODE2_ANALOG));
}
...
*/
__STATIC_INLINE void LED_CONNECTED_OUT(uint32_t bit) { UNUSED(bit); }
...
*/
__STATIC_INLINE void LED_RUNNING_OUT(uint32_t bit) { UNUSED(bit); }
